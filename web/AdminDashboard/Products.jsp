                ...
                <div class="main">
                    <div class="nav-panel">
                        <ul>
                            ...
                            <li><input type="radio" name="dashlink" id="products" value="product" checked=""/><label for="products"><a href="Products.jsp" >Products<span><i class='fa-solid fa-arrow-right'></i></span></a></label> </li>          
                    ...
                    <div class="mainContent">
                        ...
                        <table class="table table-bordered border-primary">
                                ...
                                <%
                                    getp=new getProductData();                                    
                                    List<Product> produts=getp.getProducts();
                                    int n=1;
                                ...
                                <td><% 
                                    if(("NotApproved").equals(p.getProductGranted())){
                                        %>
                                        <button onclick="approveItem(this.value)" value="<%= p.getProductId() %>"  class="btn btn-primary">Approve</button>    
                                    <%} 
                                    else{
                                    %>
                                ...
                                <td class="action">
                                    ...
                                    <a class="btn btn-primary" href="../ProductEdit?productid=<%= p.getProductId() %>" >Edit</a> |<!-- comment -->
